    ...
    return (
        <div className="populares">
            ...
            <div className="populares__cards">
                ...
                <Card imagem={Img3Card} texto="Ramen tradicional"texto2="Ramen tradicional traz a autenticidade da culinária japonesa com seu caldo rico e ingredientes clássicos."/>
            </div>
        </div>
    )
}
